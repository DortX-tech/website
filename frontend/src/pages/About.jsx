  ...
  return (
    <section ref={ref} className="relative pt-40 pb-20 overflow-hidden">
      ...
      <motion.div style={{ y }} className="relative max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <h1 className="font-display text-[48px] sm:text-[72px] lg:text-[96px] leading-[0.95] font-semibold mt-6 max-w-5xl">
      ...
      <div className="max-w-5xl mx-auto px-6 lg:px-8">
        ...
        <div className="mt-14 grid lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-5">
            <div className="sticky top-32 glass rounded-2xl p-7">
        ...
        <div className="mt-14 divide-y divide-white/8">
          {items.map((x, i) => (
            <motion.div
              ...
              className="grid lg:grid-cols-12 gap-6 py-7 group hover:bg-white/[0.02] px-4 -mx-4 rounded-2xl transition"
            >
              <div className="lg:col-span-1 font-display text-[#3B4660] text-[18px]">0{i + 1}</div>
              <div className="lg:col-span-4 font-display text-white text-[20px] font-semibold">{x.t}</div>
        ...
        <div className="mt-14 grid sm:grid-cols-2 lg:grid-cols-4 gap-3">
          {VALUES.map((v, i) => (
            <motion.div
              ...
              className="spotlight rounded-2xl border border-white/8 bg-white/[0.02] p-6"
            >
              <div className="text-[10.5px] uppercase tracking-[0.16em] text-[#6B7385]">0{i + 1}</div>
              <div className="mt-3 font-display text-white text-[20px] font-semibold">{v.t}</div>
  ...
  return (
    <section className="relative py-28">
      <div className="max-w-5xl mx-auto px-6 lg:px-8 text-center">
        ...
        <p className="mt-8 text-[17px] text-[#9AA3B8] max-w-2xl mx-auto leading-relaxed">
        ...
        <MagneticButton strength={14} className="mt-10 inline-block">
